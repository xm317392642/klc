...
import com.xr.ychat.main.fragment.ContactListFragment;
import com.xr.ychat.main.fragment.MainTabFragment;
import com.xr.ychat.main.fragment.SessionListFragment;
import com.xr.ychat.main.reminder.ReminderId;

public enum MainTab {
    RECENT_CONTACTS(0, ReminderId.SESSION, SessionListFragment.class, R.string.home_tab_chat, R.layout.session_list),
    CONTACT(1, ReminderId.CONTACT, ContactListFragment.class, R.string.home_tab_contact, R.layout.contacts_list);
