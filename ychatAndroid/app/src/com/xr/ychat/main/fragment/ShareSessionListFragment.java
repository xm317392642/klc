 ...
 * 最近聊天
 */
public class ShareSessionListFragment extends MainShareTabFragment {
    ...
    public ShareSessionListFragment() {
        this.setContainerId(MainShareTab.RECENT_CONTACTS.fragmentId);
    }
    ...
    Observer<List<OnlineClient>> clientsObserver = new Observer<List<OnlineClient>>() {
        ...
        public void onEvent(List<OnlineClient> onlineClients) {
            ShareSessionListFragment.this.onlineClients = onlineClients;
    ...
    private void addRecentContactsFragment() {
        ...
        final MainShareActivity activity = (MainShareActivity) getActivity();
