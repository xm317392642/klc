package com.xr.ychat.main.reminder;
...
public class ReminderManager {
    ...
    public final void updateContactDeltaUnreadNum(int delta) {
        updateUnreadMessageNum(delta, true, ReminderId.CONTACT);
    }
    ...
    public final int getContactUnreadNum() {
        ReminderItem item = items.get(ReminderId.CONTACT);
        if (item == null) {
            return 0;
        }
