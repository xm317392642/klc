 ...
 */
public class SystemMessageActivity extends SwipeBackUI implements TAdapterDelegate,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteMessage.setOnClickListener(view -> {
            EasyAlertDialog alertDialog = new EasyAlertDialog(SystemMessageActivity.this);
            alertDialog.setMessage("是否要清空列表?");
    ...
    private void onProcessSuccess(final boolean pass, SystemMessage message) {
        ...
        if (pass && message.getType() == SystemMessageType.ApplyJoinTeam) {
            UpdateMemberChangeService.start(SystemMessageActivity.this, message.getFromAccount(), message.getTargetId(), 1, "qr");
        }
