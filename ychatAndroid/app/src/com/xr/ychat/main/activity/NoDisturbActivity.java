 ...
 */
public class NoDisturbActivity extends SwipeBackUI implements SettingsAdapter.SwitchChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar.setTitle("");
        toolbarTitle.setText(R.string.no_disturb);
    ...
    private void setNoDisturbReq(final boolean checked, final String sTime, final String eTime) {
        NIMClient.getService(MixPushService.class).setPushNoDisturbConfig(checked,
            ...
            public void onSuccess(Void param) {
                ...
                if (checked) {
                    showTimeSetting();
                    YchatToastUtils.showShort( "开启免打扰功能成功");
                } else {
                    closeTimeSetting();
                    YchatToastUtils.showShort("关闭免打扰功能成功");
                }
            }
    ...
    private void saveStatusConfig(boolean ischecked) {
        ...
        noDisturbItem.setChecked(ischecked);
        adapter.notifyDataSetChanged();
    }
    ...
    private void openFromTimePicker(final boolean isStartTime, String time) {
        ...
        TimePickerDialog timePicker = new TimePickerDialog(this, R.style.MyDatePickerDialogTheme, new TimePickerDialog.OnTimeSetListener() {
            @Override
