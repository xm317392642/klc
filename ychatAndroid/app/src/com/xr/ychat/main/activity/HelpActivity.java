...
public class HelpActivity extends SwipeBackUI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActivityView(R.layout.help_activity);
        Intent intent = getIntent();
        url = intent.getStringExtra(URL);
        title = intent.getStringExtra(TITLE);
        if (title == null) {
            Uri uri = getIntent().getData();
            url = "http://complaint.yaoliaoim.com/dist/#/home";
            title = uri.getQueryParameter(TITLE);
            String team_id = uri.getQueryParameter("team_id");
            String person_id = uri.getQueryParameter("person_id");
            String ychatNo = SPUtils.getInstance().getString(CommonUtil.YCHAT_ACCOUNT);
            if (!TextUtils.isEmpty(person_id)) {
                url = url + "?person_id=" + person_id + "&complaint_id=" + ychatNo;
            } else {
                url = url + "?team_id=" + team_id + "&complaint_id=" + ychatNo;
            }
        }
