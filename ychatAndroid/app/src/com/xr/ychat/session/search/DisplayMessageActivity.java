package com.xr.ychat.session.search;
...
public class DisplayMessageActivity extends UI implements ModuleProxy {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView toolbarTitle = findViewById(com.netease.nim.uikit.R.id.toolbar_title);
        toolbarTitle.setText(UserInfoHelper.getUserTitleName(account, sessionType));
