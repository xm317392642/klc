...
package com.xr.ychat.common.ui.viewpager;
...
import com.xr.ychat.main.reminder.ReminderSettings;
...
public class PagerSlidingTabStrip extends HorizontalScrollView implements OnPageChangeListener {
    ...
    private int indicatorColor = 0xFFBE6913;//选中下划线的颜色
    ...
    private int checkedTextColor = 0xFFBE6913;

    private int unCheckedTextColor = 0xFF010101;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        checkedTextColor = a.getResourceId(R.styleable.TwoTextView_ttLeftTextColor, R.color.black);
