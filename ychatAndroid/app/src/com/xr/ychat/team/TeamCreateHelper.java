...
public class TeamCreateHelper {
    ...
    public static void createNormalTeam(final Context context, List<String> memberAccounts, final boolean isNeedBack, final RequestCallback<CreateTeamResult> callback) {
        ...
        fields.put(TeamFieldEnum.BeInviteMode, TeamBeInviteModeEnum.NoAuth);//将原来的默认模式改为：不需要被邀请方同意
                ...
                new RequestCallback<CreateTeamResult>() {
                    ...
                    public void onSuccess(CreateTeamResult result) {
                        ...
                        if (failedAccounts != null && !failedAccounts.isEmpty()) {
                            ...
                            UpdateMemberChangeService.start(context, createMembersString(memberAccounts), NimUIKit.getAccount(), 1, NimUIKit.getAccount());
    ...
    public static void createAdvancedTeam(final Context context, List<String> memberAccounts) {
        ...
        DialogMaker.showProgressDialog(context, context.getString(com.netease.nim.uikit.R.string.empty), false);
        // 创建群
     ...
     * 群创建成功回调
     */
    private static void onCreateSuccess(final Context context, CreateTeamResult result, List<String> memberAccounts) {
        if (result == null) {
