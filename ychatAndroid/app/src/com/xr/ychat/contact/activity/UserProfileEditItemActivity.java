 ...
 */
public class UserProfileEditItemActivity extends SwipeBackUI implements View.OnClickListener {
    ...
    private void setTitles() {
        switch (key) {
            case UserConstant.KEY_NICKNAME:
                toolbarTitle.setText(R.string.nickname);
                break;
            case UserConstant.KEY_PHONE:
                toolbarTitle.setText(R.string.phone_number);
            ...
            case UserConstant.KEY_SIGNATURE:
                toolbarTitle.setText(R.string.signature);
                break;
            case UserConstant.KEY_GENDER:
                toolbarTitle.setText(R.string.gender);
                break;
            case UserConstant.KEY_BIRTH:
                toolbarTitle.setText(R.string.birthday);
                break;
            case UserConstant.KEY_ALIAS:
                toolbarTitle.setText(R.string.alias);
                break;
        }
    }
    ...
    private void findEditText() {
        ...
        if (key == UserConstant.KEY_ALIAS) {
            ...
            if (!TextUtils.isEmpty(alias)) {
                ...
                editText.setText(NimUIKit.getUserInfoProvider().getUserInfo(data).getName());
                editText.setSelection(editText.getText().length());
            }
        } else {
        ...
        toolbarView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (key == UserConstant.KEY_NICKNAME && TextUtils.isEmpty(editText.getText().toString().trim())) {
                    YchatToastUtils.showShort(R.string.nickname_empty);
                    return;
                }
    ...
    private void onUpdateCompleted(Serializable content) {
        ContactHttpClient.getInstance().updateUserInfo(Preferences.getWeiranUid(this), Preferences.getWeiranToken(this), (key == UserConstant.KEY_NICKNAME) ? 2 : 3, content.toString(), new ContactHttpClient.ContactHttpCallback<RequestInfo>() {
            @Override
