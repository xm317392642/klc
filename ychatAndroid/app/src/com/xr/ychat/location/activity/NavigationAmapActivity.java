package com.xr.ychat.location.activity;
...
import com.xr.ychat.location.helper.MapHelper;
...
public class NavigationAmapActivity extends SwipeBackUI implements
...
//        setToolBar(R.id.toolbar, options);
    ...
    private void updateSendStatus() {
        ...
        if (TextUtils.isEmpty(myAddressInfo)) {
            toolbarTitle.setText(R.string.location_loading);
            sendButton.setVisibility(View.GONE);
        } else {
            toolbarTitle.setText(R.string.location_map);
            sendButton.setVisibility(View.GONE);
        }
    }
    ...
    private void showLocationFailTip() {
        if (firstLocation && firstTipLocation) {
            ...
            YchatToastUtils.showShort( R.string.location_address_fail);
        }
    }
