...
import com.xr.ychat.location.helper.NimGeocoder;
...
public class LocationAmapActivity extends SwipeBackUI implements OnCameraChangeListener, OnClickListener
        , NimLocationListener {
...
//	private static final String TAG = "LocationAmapActivity";
    ...
    private void updateSendStatus() {
        ...
        if (btnMyLocation.getVisibility() == View.VISIBLE || Math.abs(-1 - cacheLatitude) < 0.1f) {
            ...
            toolbarTitle.setText(R.string.my_location);
        }
    }
