...
public class EasyAlertDialog extends Dialog {
    ...
    public void addPositiveButton(CharSequence title, int color, float size,
        ...
        positiveBtnTitle = TextUtils.isEmpty(title) ? context.getString(R.string.ok) : title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (isNegativeBtnVisible) {
                ...
                positiveBtn.setBackgroundResource(R.drawable.nim_list_item_bottom_selector);//只有一个确定按钮的时候，重新设置一下背景
            }
