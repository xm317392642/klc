...
public class QrCodeUtils {
     ...
     * @param characterSet    字符集/字符转码格式 (支持格式:{@link com.google.zxing.common.CharacterSetECI })。传null时,zxing源码默认使用 "ISO-8859-1"
     * @param errorCorrection 容错级别 (支持级别:{@link com.google.zxing.qrcode.decoder.ErrorCorrectionLevel })。传null时,zxing源码默认使用 "L"
    ...
    public static Bitmap createQRCodeBitmap(String content, int width, int height,
                                            ...
                                            @Nullable String margin, @ColorInt int colorBlack,
