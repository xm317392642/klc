...
public final class NimUIKitImpl {
    ...
    public static void startP2PSession(Context context, String account, IMMessage anchor) {
        commonP2PSessionCustomization.backgroundUri = CommonUtil.getBackgroundUrl();
    ...
    public static void startChatting(Context context, String id, SessionTypeEnum sessionType, SessionCustomization
        ...
        if (UserPreferences.getShare()) {
            ...
            if(UserPreferences.SHARE_IMG.equals(value)){
                CommonUtil.sharePicDialog(context, id, sessionType, customization, anchor);
            }else if(UserPreferences.SHARE_URL.equals(value)){
                CommonUtil.shareGameDialog(context, id, sessionType, customization, anchor);
            }
        } else {
