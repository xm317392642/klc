 ...
 */
public class ContactSelectActivity extends SwipeBackUI implements View.OnClickListener, android.support.v7.widget.SearchView.OnQueryTextListener {
    ...
    private RoundRectTextView btnSelect;
...
//        }
    ...
    private void parseIntentData() {
        ...
        toolbarTitle.setText(option.title);
    }
                ...
                if (option.multi) {
                    ...
                    if (contactAdapter.isSelected(position)) {
                        ...
                        if (contactSelectedAdapter.getCount() <= option.maxSelectNum) {
                            ...
                            YchatToastUtils.showShort(option.maxSelectedTip);
                        }
    ...
    private void initContactSelectArea() {
        btnSelect = (RoundRectTextView) findViewById(R.id.btnSelect);
    ...
    private boolean showMaxMinSelectTip(boolean min) {
        if (min) {
            YchatToastUtils.showShort( option.minSelectedTip);
        } else {
            YchatToastUtils.showShort( option.maxSelectedTip);
        }
        return false;
