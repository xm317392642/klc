 ...
 */
public class CaptureVideoActivity extends SwipeBackUI implements SurfaceHolder.Callback {
    ...
    private ImageView closeCamera; // 切换摄像头
    ...
    private void findViews() {
        ...
        closeCamera = (ImageView) findViewById(R.id.close_cameras);
    }
    ...
    private void startRecorder() {
        try {
            ...
            YchatToastUtils.showShort( R.string.start_camera_to_record_failed);
    ...
    private boolean initCamera() {
        try {
            ...
            YchatToastUtils.showShort(R.string.connect_vedio_device_fail);
            return false;
        }
