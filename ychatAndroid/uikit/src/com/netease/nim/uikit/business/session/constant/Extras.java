...
public interface Extras {
    String EXTRA_TYPEFACE= "typeface";
    ...
    String EXTRA_PIC_PATH = "pic_path";
    String EXTRA_SOURCE_NAME = "source_name";
    String EXTRA_SOURCE_SCHEME = "source_scheme";

    String EXTRA_GAME_TTILE = "title";
    String EXTRA_GAME_DES = "description";
    String EXTRA_GAME_SOURCE_NAME = "source_name";
    String EXTRA_GAME_LINKURL = "url";
    String EXTRA_GAME_LINK_ICON = "icon_url";
    String EXTRA_GAME_LINK_SOURCE = "source_icon";
