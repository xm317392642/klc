 ...
 */
public class WatchVideoActivity extends SwipeBackUI implements Callback {
    ...
    private TextView txStart, txEnd;
    ...
    private void findViews() {
        ...
        txStart = (TextView) findViewById(R.id.tx_start);
    ...
    private void initVideoSize() {
        ...
        int mediaLength = (int) (videoLength);
        txStart.setText("00:00");
        if (mediaLength < 10) {
            txEnd.setText("00:0" + mediaLength);
        } else {
            txEnd.setText("00:" + mediaLength);
        }
        ...
        public void run() {
            if (mediaPlayer != null && mediaPlayer.isPlaying()) {
                ...
                if (videoLength <= 0) {
                    ...
                    if (cProgress < 10) {
                        txStart.setText("00:0" + cProgress);
                    } else {
                        txStart.setText("00:" + cProgress);
                    }
                    seekBar.setProgress(cProgress);
        ...
        if (mediaPlayer != null) {
            if (mediaPlayer.isPlaying()) {
                ...
                if (isSurfaceCreated) {
                    ...
                    YchatToastUtils.showShort(R.string.look_video_fail_try_again);
                    return;
                }
            }
            mediaPlayer.reset();
        ...
        mediaPlayer.setOnErrorListener(new OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mp, int what, int extra) {
                try {
                    ...
                    YchatToastUtils.showShort( R.string.look_video_fail);
                }
                return true;
            }
        });
    ...
    private void onDownloadFailed() {
        ...
        downloadLayout.setVisibility(View.GONE);
        YchatToastUtils.showShort( R.string.download_video_fail);
    }
