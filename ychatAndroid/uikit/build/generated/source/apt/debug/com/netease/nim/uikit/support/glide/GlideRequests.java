...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.netease.nim.uikit.support.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.netease.nim.uikit.support.glide.GlideOptions().apply(toSet));
    }
  }
}
